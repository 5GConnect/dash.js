...
//'DashSourcesService',
var app = angular.module('DashPlayer', ['DashContributorsService', 'DashIFTestVectorsService', 'angular-flot']); /* jshint ignore:line */
...
app.controller('DashController', function ($scope, DownloadService) {
